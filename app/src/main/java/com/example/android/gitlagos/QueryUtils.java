...
public final class QueryUtils {
    ...
    public static List<Gitlagos> fetchGitlagosData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of {@link Gitlagos}s
        List<Gitlagos> gitlagoses = extractFeatureFromJson(jsonResponse);

        // Return the list of {@link Gitlagos}s
        return gitlagoses;
    }
    ...
    private static List<Gitlagos> extractFeatureFromJson(String gitlagosJSON) {
        ...
        // Create an empty ArrayList that we can start adding gitlagoses to
        List<Gitlagos> gitlagoses = new ArrayList<>();
